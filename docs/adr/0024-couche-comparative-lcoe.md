...
|---|---|---|
| **ADEME** (*Coûts des EnR&R en France*) | Renouvelables (PV, éolien, hydro, biomasse, géothermie) | Jeu de données **Licence Ouverte / Etalab 2.0** — réutilisation commerciale **explicitement permise** avec attribution. *Confiance haute.* |
| **Cour des comptes** (coûts nucléaire / système électrique) | Nucléaire **parc existant** (coût courant économique) | **Pas de licence ouverte nommée** sur `ccomptes.fr` ; conditions du site **sans clause non commerciale** + **CRPA art. L321-1** et s. (réutilisation des informations publiques, y compris commerciale, sous attribution + non-altération). *Confiance moyenne.* |
| **RTE** (*Futurs énergétiques 2050*) | **Nouveau** nucléaire + prospectif toutes filières | ⚠️ Mentions légales du **rapport restrictives** (accord écrit pour le « contenu ») ; la valeur EPR2 vient du **rapport**, **pas** d'un jeu sous Licence Ouverte. Réutilisation des **chiffres-faits** fondée sur la **non-protection des faits** (CPI L112-1) + **extraction non substantielle** (CPI L341-1/L342-3). *Confiance moyenne, risque résiduel réel.* |
