...
- **Dernière mise à jour** : 2026-09-24 (I0–I4 livrées ; I5 en cours : `carbonfr-core` et `carbonfr-eligibility` 0.9.1 **publiées sur crates.io** et docs.rs, restent le Trusted Publishing et `reqwest` 0.13 ; I1 : reste la notification Uptime Kuma).
