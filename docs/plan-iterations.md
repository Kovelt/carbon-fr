...
- **Dernière mise à jour** : 2026-09-25 — **I0 à I7 livrées** ; v0.9.5 en prod (collecte en fenêtre glissante + auto-réparation quotidienne, historique national complet depuis 2025) ; alertes e-mail Uptime Kuma actives. Restent : actions hors code de Morgan (licence ADEME, empreinte SSH, équipe `Kovelt/maintainers`, durcissement npm/crates.io — cf. « Actions hors code »), échéances datées et chantiers « en attente d'un déclencheur ».
