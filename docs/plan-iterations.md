...
- **Dernière mise à jour** : 2026-09-23 (version initiale).
...
- [ ] Merger `docs/derive-2026-09` (dérive doc ↔ code), puis **vérifier** que les dérives listées par l'état des lieux sont bien toutes closes (dont le tableau README : `/v1/stats`, refus de `acv-ademe@2` par `/v1/mix`).
- [ ] Merger `ci/durcissement-2026-09` (permissions minimales, actions épinglées par SHA, issue d'alerte si le scan planifié échoue).
